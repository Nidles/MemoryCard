...
# что делаем? 
questions_list = [] 
questions_list.append(Question('Государственный язык Бразилии', 'Португальский', 'Английский', 'Испанский', 'Бразильский', 'Русский', 'Украинский'))
questions_list.append(Question('Какого цвета нет на флаге России?', 'Зелёный', 'Красный', 'Белый', 'Синий', 'светло синий', 'Светло белый'))
questions_list.append(Question('Национальная хижина якутов', 'Ураса', 'Юрта', 'Иглу', 'Хата', 'Дом', 'Квартира'))
questions_list.append(Question('py...?', 'thon', 'tohn', 'tnho', 'noht', 'onth', 'hotn'))
...
rbtn_5 = QRadioButton() #вариант5
rbtn_6 = QRadioButton() #вариант6
...
layout_ans4.addWidget(rbtn_5) # два ответа в третий столбец
